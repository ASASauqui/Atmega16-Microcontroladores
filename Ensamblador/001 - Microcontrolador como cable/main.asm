...
;
; Fecha: 30/09/2021 4:01 p.m.
; Autor: Alan Samuel Aguirre Salazar
;******************************************************
...
//ldi R16, 0b1111_1111	//Ya no es necesario, pues ya tenía unos.
out DDRC, R16			//Configuro el puerto C como salida.
ldi R16, 0b0000_0000
out PORTC, R16			//Apago todos los LEDs del puerto C

OTRO:
	in R16, PINA		//En R16 queda lo que está en los botones en ese momento.
	out PORTC, R16		//Saco lo leído por el puerto C
rjmp OTRO				//Ciclo infinito.
